---
description: I prompt to transform Claude Code, Cursor, or Windsurf into React + Framer Motion expert. Complete animation integration with shadcn/ui and TypeScript.
---
