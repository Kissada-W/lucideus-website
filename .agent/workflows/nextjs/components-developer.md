---
description: AI prompt to transform Claude Code, Cursor, or Windsurf into shadcn/ui + React component expert. Complete TypeScript integration with accessibility.
---
